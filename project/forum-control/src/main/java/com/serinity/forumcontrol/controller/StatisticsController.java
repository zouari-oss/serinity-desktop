...
import com.serinity.forumcontrol.model.ForumStatistics;
import com.serinity.forumcontrol.service.ServiceStatistics;
    ...
    private void onBack() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxml/ForumBackoffice.fxml")
            );
