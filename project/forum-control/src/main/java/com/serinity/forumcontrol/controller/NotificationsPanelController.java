...
import com.serinity.forumcontrol.model.Notification;
...
public class NotificationsPanelController {
    ...
    public void loadNotifications() {
        ...
        List<Notification> notifications = notificationService.getUserNotifications("1");
            ...
            for (Notification notification : notifications) {
                try {
                    FXMLLoader loader = new FXMLLoader(
                            getClass().getResource("/fxml/Notificationcard.fxml")
                    );
    ...
    private void onNotificationClick(Notification notification) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxml/ThreadDetailView.fxml")
            );
    ...
    private void onMarkAllAsRead() {
        notificationService.markAllAsSeen("1");
        loadNotifications();
    ...
    private void onClearAll() {
        ...
        if (confirm.showAndWait().get() == ButtonType.OK) {
            notificationService.deleteAllForUser("1");
            loadNotifications();
