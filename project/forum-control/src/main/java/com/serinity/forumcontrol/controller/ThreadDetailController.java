...
import com.serinity.forumcontrol.model.Reply;
import com.serinity.forumcontrol.model.ThreadStatus;
import com.serinity.forumcontrol.service.*;
        ...
        try {
            FXMLLoader loader =
                    new FXMLLoader(getClass()
                            .getResource("/fxml/ReplyCard.fxml"));
    ...
    private void goBack() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass()
                    .getResource("/fxml/ForumPostsView.fxml"));
    ...
    private BorderPane findBorderPane() {
        ...
        while (node != null) {
            if (node instanceof BorderPane) {
                last = (BorderPane) node; // keep going to find the outermost one
            }
            node = node.getParent();
        }
        return last;
