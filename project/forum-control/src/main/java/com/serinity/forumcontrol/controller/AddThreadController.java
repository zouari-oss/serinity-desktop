...
import com.serinity.forumcontrol.service.ServiceImgBB;
import com.serinity.forumcontrol.service.Moderate;
...
public class AddThreadController {
    ...
    private void returnToForum() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ForumPostsView.fxml"));
