...
import com.serinity.accesscontrol.dao.exercice.SessionDAO;
import com.serinity.accesscontrol.model.exercice.Exercise;
import com.serinity.accesscontrol.model.exercice.Resource;
import com.serinity.accesscontrol.service.exercice.ExerciseService;
import com.serinity.accesscontrol.service.exercice.ResourceService;
import com.serinity.accesscontrol.service.exercice.SessionService;
...
public class ExerciseDetailsController {
    ...
    private Parent loadResourceCard(Resource r) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/exercice/exercice/ResourceCard.fxml"));
    ...
    private void onAddResource() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/exercice/exercice/ResourceForm.fxml"));
            Parent root = loader.load();
    ...
    private void onStart() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/exercice/exercice/SessionRun.fxml"));
            Parent root = loader.load();
    ...
    private void onOpenHistory() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/exercice/exercice/SessionHistory.fxml"));
            Parent root = loader.load();
