 ...
 * timestamps. Extends {@link IdentifiableEntity} to inherit a UUID primary key.
 *
 * <p>
 * This class is annotated with {@code @MappedSuperclass}, so it does not
 ...
 * </p>
 * <ul>
 * <li>{@code createdAt} – the timestamp when the entity was first persisted;
 * immutable.</li>
 * <li>{@code updatedAt} – the timestamp of the last update to the entity;
 * automatically updated on modification.</li>
 * </ul>
 *
 * <p>
 * NOTE: skinnedRatORM annotations
 * {@link org.zouarioss.skinnedratorm.annotations.CreationTimestamp} and
 * {@link org.zouarioss.skinnedratorm.annotations.UpdateTimestamp} are used to
 ...
 *        <a
 *        href=
 *        "https://github.com/zouari-oss/serinity-desktop/tree/main/project/access-control/src/main/java/com/serinity/accesscontrol/model/base/TimestampedEntity.java">
 *        TimestampedEntity.java
 *        </a>
 */
@MappedSuperclass
