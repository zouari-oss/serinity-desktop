package com.serinity.exercicecontrol.controller.admin;

import com.serinity.exercicecontrol.controller.ExerciseFormController;
import com.serinity.exercicecontrol.dao.AdminDashboardDao;
...
public class AdminDashboardController {
    ...
    private void openDialogAndWait(String title, Parent root) {
        ...
        var css = getClass().getResource("/styles/adminstyle.css");
