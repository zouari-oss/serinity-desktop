...
public class MoodHistoryCardController {
    ...
    @FXML private Label emotionsTitle;
    @FXML private FlowPane emotionsPane;
    @FXML private Label influencesTitle;
    @FXML private FlowPane influencesPane;
    ...
    public void initialize() {
        ...
        btnEdit.setOnAction(e -> {
            if (onEdit != null && vm != null) onEdit.accept(vm);
        });
        btnDelete.setOnAction(e -> {
            if (onDelete != null && vm != null) onDelete.accept(vm);
        });
    }
    ...
    public void setData(
        ...
        for (String code : vm.emotions) emotionsPane.getChildren().add(tag(t("emotion." + code), "emotion-tag"));

        influencesPane.getChildren().clear();
        for (String code : vm.influences) influencesPane.getChildren().add(tag(t("influence." + code), "influence-tag"));
    }
