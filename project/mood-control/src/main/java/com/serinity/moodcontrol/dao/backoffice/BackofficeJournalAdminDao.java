...
import com.serinity.moodcontrol.config.DbConnection;
...
public class BackofficeJournalAdminDao {
  ...
  /**
   * @param nameLikeOrNull null/blank => all users; otherwise filters by
   *                       username/first/last LIKE
   */
  public List<BackofficeJournalRow> findAll(String nameLikeOrNull) throws SQLException {
    ...
    final String sql = "SELECT je.id, je.user_id, je.title, je.created_at, je.updated_at, " +
