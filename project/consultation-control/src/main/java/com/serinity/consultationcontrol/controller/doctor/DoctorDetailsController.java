...
import com.serinity.consultationcontrol.service.DoctorService;
...
public class DoctorDetailsController {
    ...
    public void initialize(){
        String id = AppSession.getSelectedDoctorId();
        ...
        addressLabel.setText(doctor.getAddress()==null?"Adresse non renseignee":doctor.getAddress());
        nameLabel.setText(doctor.getFullName());
        emailLabel.setText(doctor.getEmail());
        phoneLabel.setText(doctor.getPhone());
        specialityLabel.setText(doctor.getSpeciality()==null?"Medecin generaliste":doctor.getSpeciality());
    ...
    private String generateVCard(User d){
        ...
        return "BEGIN:VCARD\n" +
                ...
                "FN:" + d.getFullName() + "\n" +
                "ORG:Cabinet Medical\n" +
                "TITLE:" + (d.getSpeciality()==null?"Medecin":d.getSpeciality()) + "\n" +
                "TEL;TYPE=CELL:" + phone + "\n" +
