...
public class ExerciseListController {
    ...
    private void setContent(Parent page) {
        // Try standalone Template.fxml mode first, then access-control's contentHostStackPane
        StackPane host = (StackPane) cardsPane.getScene().lookup("#contentHost"); if (host == null) host = (StackPane) cardsPane.getScene().lookup("#contentHostStackPane");
        if (host == null)
            host = (StackPane) cardsPane.getScene().lookup("#contentHostStackPane");
