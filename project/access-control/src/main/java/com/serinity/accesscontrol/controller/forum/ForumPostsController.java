...
import com.serinity.accesscontrol.model.forum.ThreadStatus;
import com.serinity.accesscontrol.model.forum.ThreadType;
import com.serinity.accesscontrol.service.forum.ServiceCategory;
import com.serinity.accesscontrol.service.forum.ServiceNotification;
import com.serinity.accesscontrol.service.forum.ServicePostInteraction;
...
import com.serinity.accesscontrol.model.forum.Thread;
import com.serinity.accesscontrol.service.forum.ServiceThread;
...
public class ForumPostsController {
    String currentUserId= LoginController.getUser().getId().toString();
    ...
    public void loadThreads() {
        ...
        try {
            ...
            List<Thread> threads = service.getAll(LoginController.getUser().getId().toString()).stream().filter(t-> t.getStatus()!= ThreadStatus.ARCHIVED).toList();
    ...
    public void loadMyThreads() {
        ...
        try {
            cardsContainer.getChildren().clear();
            ServiceThread service = new ServiceThread();
            List<Thread> threads = service.getAll().stream().filter(t-> t.getUserId().equalsIgnoreCase(LoginController.getUser().getId().toString())).filter(t-> t.getStatus()!= ThreadStatus.ARCHIVED).toList();
            currentThreads = threads;
            displayThreads(threads);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void loadArchivedThreads() {
        ...
        try {
            cardsContainer.getChildren().clear();
            ServiceThread service = new ServiceThread();
            List<Thread> threads = service.getAll().stream().filter(t-> (t.getUserId().equalsIgnoreCase(LoginController.getUser().getId().toString())) && t.getStatus()== ThreadStatus.ARCHIVED).toList();
            currentThreads = threads;
            displayThreads(threads);
        } catch (Exception e) {
            e.printStackTrace();
