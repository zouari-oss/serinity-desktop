...
import com.serinity.accesscontrol.service.consultation.DoctorService;
...
public class DoctorListController {
    ...
    private void startPulseAnimation(){
        ...
        ScaleTransition pulse = new ScaleTransition(Duration.seconds(1.2), aiButton);
        pulse.setFromX(1);
        pulse.setFromY(1);
        pulse.setToX(1.05);
        pulse.setToY(1.05);
        ...
        FadeTransition glow = new FadeTransition(Duration.seconds(1.2), aiButton);
