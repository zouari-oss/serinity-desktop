...
public class AdminDashboardController {
    ...
    private static final String CSS_PATH          = "/styles/sleepcontrol/styles.css";
    private static final String REVE_FORM_FXML    = "/fxml/sleepcontrol/reve-form.fxml";
    private static final String SOMMEIL_FORM_FXML = "/fxml/sleepcontrol/sommeil-form.fxml";
    ...
    private void ouvrirFormulaireSommeil(Sommeil sommeilAModifier) {
        try {
            var url = getClass().getResource("/fxml/sleepcontrol/sommeil-form.fxml");
            if (url == null) {
                afficherErreur("FXML introuvable", "Fichier non trouvé : fxml/sleepcontrol/sommeil-form.fxml");
                return;
            }
    ...
    private void ouvrirFormulaireReve(Reve reveAModifier) {
        try {
            var url = getClass().getResource("/fxml/sleepcontrol/reve-form.fxml");
            if (url == null) {
                afficherErreur("FXML introuvable", "Fichier non trouvé : fxml/sleepcontrol/reve-form.fxml");
                return;
            }
            FXMLLoader loader = new FXMLLoader(url);
            Parent parent = loader.load();
