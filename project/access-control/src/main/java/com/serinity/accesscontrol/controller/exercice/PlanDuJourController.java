...
import com.serinity.accesscontrol.service.exercice.ContextAwarePlanner;
import com.serinity.accesscontrol.service.exercice.FatigueEstimationService;
import com.serinity.accesscontrol.service.exercice.ContextAwarePlanner.DailyContext;
import com.serinity.accesscontrol.service.exercice.ContextAwarePlanner.DailyPlan;
import com.serinity.accesscontrol.service.exercice.api.EnvConfig;
import com.serinity.accesscontrol.service.exercice.api.WeatherApiService;
import com.serinity.accesscontrol.service.exercice.api.YouTubeApiService;
...
StackPane host = (StackPane) lblContext.getScene().lookup("#contentHost"); if (host == null) host = (StackPane) lblContext.getScene().lookup("#contentHostStackPane");
        if (host == null)
