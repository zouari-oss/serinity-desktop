package com.serinity.accesscontrol.dto.backoffice;
...
public class BackofficeMoodRow {
  ...
  public String getMomentType() {
    return momentType.get();
  }

  public StringProperty momentTypeProperty() {
    return momentType;
  }

  public int getMoodLevel() {
    return moodLevel.get();
  }

  public IntegerProperty moodLevelProperty() {
    return moodLevel;
  }

  public String getEntryDateText() {
    return entryDateText.get();
  }

  public StringProperty entryDateTextProperty() {
  ...
  public StringProperty emotionsProperty() {
    return emotions;
  }
  ...
  public StringProperty influencesProperty() {
    return influences;
  }
}
