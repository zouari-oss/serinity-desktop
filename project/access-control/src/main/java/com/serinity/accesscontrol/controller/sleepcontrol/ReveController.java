...
import com.serinity.accesscontrol.service.sleepcontrol.ReveService;
import com.serinity.accesscontrol.service.sleepcontrol.SommeilService;
import com.serinity.accesscontrol.util.sleepcontrol.PowerBIConfig;
...
public class ReveController {
    ...
    private void afficherCards() {
        ...
        for (Reve reve : currentReves) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/sleepcontrol/reve-card.fxml"));
    ...
    private void ouvrirAnalyseIA() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/sleepcontrol/reve-analyse.fxml"));
    ...
    private void ouvrirFormulaire(Reve reve) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/sleepcontrol/reve-form.fxml"));
            Parent root = loader.load();
    ...
    private void ouvrirHumeurReveil() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxml/sleepcontrol/humeur-reveil.fxml"));
            Parent root = loader.load();
    ...
    private void onMenuSommeil() {
        try {
            Parent page = FXMLLoader.load(getClass().getResource("/fxml/sleepcontrol/sleep-page.fxml"));
            javafx.scene.layout.StackPane host = (javafx.scene.layout.StackPane) mainContainer.getScene().lookup("#contentHostStackPane");
            if (host != null) host.getChildren().setAll(page);
    ...
    private void onMenuReve() {
        try {
            Parent page = FXMLLoader.load(getClass().getResource("/fxml/sleepcontrol/reve-page.fxml"));
            javafx.scene.layout.StackPane host = (javafx.scene.layout.StackPane) mainContainer.getScene().lookup("#contentHostStackPane");
            if (host != null) host.getChildren().setAll(page);
        } catch (IOException e) { e.printStackTrace(); }
    }
