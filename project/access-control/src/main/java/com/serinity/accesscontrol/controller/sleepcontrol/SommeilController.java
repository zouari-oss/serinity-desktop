...
public class SommeilController {
    ...
    private void afficherCards() {
        ...
        for (Sommeil sommeil : currentSommeils) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/sleepcontrol/sommeil-card.fxml"));
    ...
    private void ouvrirFormulaire(Sommeil sommeil) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/sleepcontrol/sommeil-form.fxml"));
    ...
    private void ouvrirMeteo() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/sleepcontrol/weather.fxml"));
            Parent root = loader.load();
