...
public class AdminDashboardController {
    ...
    private static final String REVE_FORM_FXML    = "/fxml/reve-form.fxml";
    private static final String SOMMEIL_FORM_FXML = "/fxml/sommeil-form.fxml";
    ...
    private void ouvrirFormulaireSommeil(Sommeil sommeilAModifier) {
        try {
            var url = getClass().getResource("/fxml/sommeil-form.fxml");
            if (url == null) {
    ...
    private void ouvrirFormulaireReve(Reve reveAModifier) {
        try {
            var url = getClass().getResource("/fxml/reve-form.fxml");
            if (url == null) {
