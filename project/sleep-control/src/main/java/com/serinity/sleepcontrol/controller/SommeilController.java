...
public class SommeilController {
    ...
    private void afficherCards() {
        ...
        for (Sommeil sommeil : currentSommeils) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/sommeil-card.fxml"));
    ...
    private void ouvrirFormulaire(Sommeil sommeil) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/sommeil-form.fxml"));
