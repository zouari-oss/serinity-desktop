...
import com.serinity.sleepcontrol.util.PowerBIConfig;
...
public class ReveController {
    ...
    private void afficherCards() {
        ...
        for (Reve reve : currentReves) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/reve-card.fxml"));
    ...
    private void ouvrirAnalyseIA() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/reve-analyse.fxml"));
    ...
    private void ouvrirFormulaire(Reve reve) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/reve-form.fxml"));
            Parent root = loader.load();
    ...
    private void ouvrirHumeurReveil() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxml/humeur-reveil.fxml"));
            Parent root = loader.load();
    ...
    private void onMenuSommeil() {
        try {
            Parent page = FXMLLoader.load(getClass().getResource("/fxml/sleep-page.fxml"));
    ...
    private void onMenuReve() {
        try {
            Parent page = FXMLLoader.load(getClass().getResource("/fxml/reve-page.fxml"));
            javafx.scene.layout.StackPane host = (javafx.scene.layout.StackPane) mainContainer.getScene().lookup("#contentHostStackPane");
            if (host != null) host.getChildren().setAll(page);
        } catch (IOException e) { e.printStackTrace(); }
    }
