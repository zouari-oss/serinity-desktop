# Contributing to serinity-desktop

Thank you for your interest in contributing to serinity-desktop! Contributions from the community are welcome and appreciated.
...
2. Clone your fork to your local machine:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/serinity-desktop.git
   ```
...
Please check the [issues](https://github.com/serinity-desktop/issues) tab to see where help is needed.
...
By contributing to serinity-desktop, you agree that your contributions will be licensed under the same license as the project.
