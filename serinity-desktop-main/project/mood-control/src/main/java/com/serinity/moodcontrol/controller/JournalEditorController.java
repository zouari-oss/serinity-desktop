...
public class JournalEditorController {
    ...
    @FXML private Label editorSubtitle;

    @FXML private TextField titleField;
    @FXML private TextArea a1Area;
    @FXML private TextArea a2Area;
    @FXML private TextArea a3Area;

    @FXML private Button btnSave;
    @FXML private Label saveHint;
    ...
    @FXML
    private void onSave() {
        if (btnSave != null && btnSave.isDisable()) return; // safety
    ...
    private void updateSaveState() {
        ...
        if (mode == Mode.NEW) {
            ...
            if (!enable) hintKey = "journal.savehint.edit";
        }
